...
/*
    日志框架:
        程序中的日志可以用来记录程序运行过程中的信息, 并可以进行永久存储(保存到本地文件中)
        日志技术的优势:
            1. 可以将日志信息写入到文件或者数据库中
            2. 取消和打开日志不需要修改代码, 灵活性比较好
            3. 在多线程环境下性能较好
        日志规范:
        ...
        Logback快速入门:
            ...
            3. 创建日志对象:
                public static final Logger LOGGER = LoggerFactory.getLogger("当前类的字节码文件对象");
...
public class $1_LogFrameworkSummarize {
}
